...
import { Box, FileText, List, Bot, MessageCircle, Globe, Plus, UserPlus, Archive, Download } from 'lucide-react';
  ...
  const handleTaskClick = async (taskId: string) => {
    ...
    try {
      ...
      try {
        ...
        console.log(`已加载岸段几何: ${Object.keys(bankGeometryCacheRef.current).length} 条`);
